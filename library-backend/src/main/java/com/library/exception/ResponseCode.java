...
public enum ResponseCode {
    ...
    BORROW_BATCH_EMPTY("BORROW_BATCH_EMPTY", "請選擇要審核的借閱紀錄", HttpStatus.BAD_REQUEST),
    // 預約相關
    ...
    RESERVATION_STATUS_INVALID("RESERVATION_STATUS_INVALID", "此預約狀態不可通知",HttpStatus.BAD_REQUEST),
    RESERVATION_NOT_FIRST_QUEUE("RESERVATION_NOT_FIRST_QUEUE", "此預約不是目前第一順位，無法通知",HttpStatus.BAD_REQUEST),
    NO_AVAILABLE_COPY_FOR_RESERVATION("NO_AVAILABLE_COPY_FOR_RESERVATION", "目前無可借館藏，無法通知",HttpStatus.BAD_REQUEST),
    // 訊息相關
